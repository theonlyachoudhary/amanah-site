    ...
    <>
      <style>{`
        ...
        .antenna_shadow {
          ...
          z-index: 0;
          box-shadow: inset 0px 16px var(--primary-color, #1A73E8), inset 0px 16px 1px 1px var(--primary-color, #1A73E8);
        }
        .antenna::after {
          content: "";
          position: absolute;
        ...
        .tv {
          ...
          justify-content: center;
          border: 2px solid var(--primary-color, #1A73E8);
          box-shadow: inset 0.2em 0.2em var(--primary-color, #1A73E8);
          position: relative;
        }
        .curve_svg {
          position: absolute;
        ...
        .buttons_div {
          ...
          flex-direction: column;
          row-gap: 0.75em;
          box-shadow: 3px 3px 0px var(--primary-color, #1A73E8);
        }
        .b1, .b2 {
          width: 1.65em;
          height: 1.65em;
          ...
          background-color: var(--primary-color, #1A73E8);
          border: 2px solid var(--primary-color, #1A73E8);
          box-shadow: inset 2px 2px 1px #b49577, -2px 0px #513721, -2px 0px 0px 1px var(--primary-color, #1A73E8);
          position: relative;
        }
        .b1::before {
          content: "";
