...
export default function InfoSection({ title, subtitle, description }: InfoSectionProps) {
  return (
    <section id="info-section" className="min-h-[80vh] flex flex-col justify-center px-4 py-7 md:py-10 xl:pt-0 md:w-[90%] 2xl:w-[80%] mx-auto">
      <div className="flex flex-col text-left mb-6 md:mb-8 lg:mb-10">
