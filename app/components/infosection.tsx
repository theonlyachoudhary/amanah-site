  ...
  return (
    <section className="px-4 py-8 md:py-12 lg:py-16">
      <div className="w-full md:w-[75%] lg:w-[55%] mx-auto flex flex-col items-center text-center">
        <h3 className="font-bold text-xl sm:text-2xl lg:text-3xl text-black/80 mb-2 leading-tight whitespace-pre-line">{subtitle}</h3>
        <h2 className="font-black text-3xl sm:text-4xl lg:text-5xl text-black mb-4 leading-tight whitespace-pre-line">{title}</h2>
        <p className="font-semibold sm:text-base md:text-lg lg:text-xl text-black/65 whitespace-pre-line max-w-xs sm:max-w-md md:max-w-lg lg:max-w-4xl leading-relaxed">{description}</p>
      </div>
