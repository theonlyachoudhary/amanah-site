  ...
  return (
    <div className="relative overflow-x-hidden bg-[var(--primary-white)]">
      ...
      <div className="absolute inset-0 hidden overflow-hidden md:block">
          {/* Top row - spread across width */}
          {/* Computer/Monitor icon - top left */}
          <div className="absolute left-8 top-8 opacity-5 animate-pulse">
          ...
          <div className="absolute right-8 top-8 opacity-5 animate-bounce" style={{ animationDuration: '3s' }}>
            <svg className="h-12 w-12" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute left-20 top-24 opacity-3 animate-bounce" style={{ animationDuration: '6s', animationDelay: '0.8s' }}>
          ...
          <div className="absolute right-20 top-24 opacity-3 animate-pulse" style={{ animationDelay: '2.2s' }}>
            <svg className="h-8 w-8" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute left-4 top-1/2 -translate-y-1/2 opacity-4 animate-pulse" style={{ animationDelay: '1s' }}>
            <svg className="h-10 w-10" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 opacity-4 animate-bounce" style={{ animationDuration: '4s', animationDelay: '0.5s' }}>
            <svg className="h-10 w-10" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute left-32 bottom-32 opacity-3 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1.2s' }}>
            <svg className="h-8 w-8" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute right-32 bottom-32 opacity-3 animate-pulse" style={{ animationDelay: '3s' }}>
            <svg className="h-8 w-8" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
            </svg>
          </div>

          {/* Bottom row - spread across width */}
          {/* Money/Dollar - bottom left */}
          <div className="absolute left-12 bottom-8 opacity-4 animate-bounce" style={{ animationDuration: '5s' }}>
            <svg className="h-10 w-10" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="absolute right-12 bottom-8 opacity-4 animate-pulse" style={{ animationDelay: '1.5s' }}>
            <svg className="h-10 w-10" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
            </svg>
          </div>

          {/* Additional scattered elements for full height coverage */}
          {/* Upper quarter scattered */}
          <div className="absolute left-1/4 top-16 opacity-2 animate-pulse" style={{ animationDelay: '4s' }}>
            <svg className="h-6 w-6" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
            </svg>
          </div>

          <div className="absolute right-1/4 top-20 opacity-2 animate-bounce" style={{ animationDuration: '7s', animationDelay: '2.5s' }}>
            <svg className="h-6 w-6" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />
            </svg>
          </div>

          {/* Middle height scattered */}
          <div className="absolute left-16 top-1/3 opacity-2 animate-pulse" style={{ animationDelay: '1.8s' }}>
            <svg className="h-5 w-5" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
            </svg>
          </div>

          <div className="absolute right-16 top-2/3 opacity-2 animate-bounce" style={{ animationDuration: '5s', animationDelay: '3.2s' }}>
            <svg className="h-5 w-5" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5m0 15V21m3.75-18v1.5m0 15V21m-9-1.5h10.5a2.25 2.25 0 0 0 2.25-2.25V6.75a2.25 2.25 0 0 0-2.25-2.25H6.75A2.25 2.25 0 0 0 4.5 6.75v10.5a2.25 2.25 0 0 0 2.25 2.25Zm.75-12h9v9h-9v-9Z" />
            </svg>
          </div>

          {/* Lower quarter scattered */}
          <div className="absolute left-24 bottom-20 opacity-2 animate-pulse" style={{ animationDelay: '2.8s' }}>
            <svg className="h-5 w-5" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
            </svg>
          </div>

          <div className="absolute right-24 bottom-24 opacity-2 animate-bounce" style={{ animationDuration: '6s', animationDelay: '1.5s' }}>
            <svg className="h-5 w-5" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
            </svg>
          </div>

          {/* Far edges for full coverage */}
          <div className="absolute left-2 top-1/4 opacity-1 animate-pulse" style={{ animationDelay: '4.5s' }}>
            <svg className="h-4 w-4" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
            </svg>
          </div>

          <div className="absolute right-2 bottom-1/4 opacity-1 animate-bounce" style={{ animationDuration: '8s', animationDelay: '0.7s' }}>
            <svg className="h-4 w-4" style={{ color: 'var(--primary-color)' }} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="m6.75 7.5 3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" />
            </svg>
          </div>
      ...
      {/* Content section */}
      <div className="relative py-12 sm:py-16 lg:pt-40 xl:pb-0">
