    ...
    `}>
      ...
      `}>
        ...
        <div className="hidden md:flex items-center justify-center flex-wrap">
          <Link
            href="/"
            className={`font-bold text-[16px] lg:text-[18px] xl:text-[20px] mx-[15px] lg:mx-[25px] xl:mx-[40px] text-center transition-colors duration-300 hover:text-[var(--secondary-color)] whitespace-nowrap`}
          >
            HOME
          </Link>
          <Link
        ...
        {/* Mobile Menu Title */}
        <div className="md:hidden font-bold text-[17px] text-center">
          MENU
        </div>
      </div>
      ...
      {/* Mobile Menu Overlay */}
      <div className={`
        md:hidden fixed left-1/2 transform -translate-x-1/2 z-40 
        ...
        ${isScrolled 
          ? 'top-[70px] md:top-[80px] w-full' 
          : 'top-[110px] md:top-[140px] w-[95%]'
        }
      `}>
          <Link
            href="/"
            className="font-bold text-[18px] text-center transition-colors duration-300 hover:text-[var(--secondary-color)] py-2"
